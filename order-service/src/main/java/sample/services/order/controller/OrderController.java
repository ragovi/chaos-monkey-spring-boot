package sample.services.order.controller;
...
import sample.services.order.client.CustomerClient;
import sample.services.order.client.ProductClient;
import sample.services.order.model.Customer;
import sample.services.order.model.Order;
import sample.services.order.model.OrderStatus;
import sample.services.order.model.Product;
import sample.services.order.repository.OrderRepository;
